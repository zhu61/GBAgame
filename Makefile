...
OFILES = main.o background.o myLib.o font.o text.o face.o  monster.o gameover.o win.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = myLib.h DMA.h background.h text.h face.h monster.h gameover.h win.h
